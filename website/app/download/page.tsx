...
export const metadata: Metadata = {
  ...
  description:
    "Download Augment for macOS. Free, secure, and powerful file versioning software. Compatible with macOS 11+ and Apple Silicon Macs.",
  openGraph: {
    title: "Download Augment - Free File Versioning for macOS",
    description:
      "Get started with Augment today. Free download, no account required, works on all modern Macs.",
  },
};
...
export default function DownloadPage() {
  return (
    <>
      <DownloadHero />
      <DownloadStats type="augment-macos" />
      <DownloadOptions />
      <SystemRequirements />
      <InstallationGuide />
      <FAQ />
