...
public class AugmentLogger {
    ...
    private func setupFileLogging() {
        ...
        do {
            ...
            try FileManager.default.createDirectory(at: augmentLogsURL, 
    ...
    public func error(_ error: Error, message: String? = nil, category: LogCategory = .general,
                     file: String = #file, function: String = #function, line: Int = #line) {
    ...
    private func log(level: LogLevel, message: String, category: LogCategory,
        ...
        logQueue.async {
            ...
            let formattedMessage = "[\(timestamp)] [\(level.description)] [\(category.rawValue)] [\(location)] \(message)"
    ...
    public func measureTime<T>(
        ...
        info("\(message) completed in \(String(format: "%.3f", timeElapsed))s", 
